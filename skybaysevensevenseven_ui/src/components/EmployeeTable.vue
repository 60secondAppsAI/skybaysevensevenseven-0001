...
<template>
        ...
        <card>
          <template slot="header">
            <div class="row justify-content-between align-items-between mx-3">
              ...
              <div>
                  <base-button class="btn btn-primary" @click="modalEmployees = true">Add</base-button>
              </div>
              
              <modal :show.sync="modalEmployees">
                <template slot="header">
  ...
  <base-input label="HireDate" type="text" placeholder="Enter HireDate" v-model="employeeToAdd.hireDate"></base-input>
          ...
          <div v-if="isTableView">
            ...
            <a-table :columns="columns" :data-source="employees" :row-key="record => record.EmployeeId" :pagination="pagination"
          ...
          <div v-else>
            ...
            <EmployeePictureView :employees="employees" />
          </div>
...
import EmployeePictureView from './EmployeePictureView.vue';
...
export default {
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'hireDate',
          ...
          sorter: true
          //sorter: (a, b) => a.hireDate - b.hireDate,
      ...
      sortBy: 'employeeId',           // Column to sort by
  ...
  methods: {
    ...
    async renderEmployeesTable() {
      ...
      for (let i = 0; i < this.employees.length; i++) {
        employeesTableData.push({
          ...
          year: this.employees[i].year,
          date: this.employees[i].date,
          competitionId: this.employees[i].competitionId,
          employeeId: this.employees[i].employeeId,
        });
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-employees',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    routingToEmployeeDetail(id) {
      this.$router.push({ name: 'EmployeeDetail', params: { employeeId: id.toString() }})
    },
    
    handleSearchQueryChanged() {
    	console.log("handleSearchQueryChanged CALLED FROM @search")
    	this.$root.$emit('searchQueryForEmployeesChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.employeeToAdd.created = currentDate;
