...
<template>
  ...
  <base-input label="FoundedYear" type="text" placeholder="Enter FoundedYear" v-model="airlineToAdd.foundedYear"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'foundedYear',
          visible: true,
          scopedSlots: { customRender: 'foundedYear' },
          sorter: true
          //sorter: (a, b) => a.foundedYear - b.foundedYear,
          //sorter: (a, b) => a.foundedYear.localeCompare(b.foundedYear),
        },
      ],
      pagination: {
        current: 1,
