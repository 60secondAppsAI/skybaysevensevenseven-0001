						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ExperienceYears" type="text" placeholder="Enter ExperienceYears" v-model="crewToAdd.experienceYears"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Experience Years</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ExperienceYears" type="text" placeholder="Enter ExperienceYears" v-model="crewDetails.experienceYears"></input>
																		</div>
						</td>
														</tr>
